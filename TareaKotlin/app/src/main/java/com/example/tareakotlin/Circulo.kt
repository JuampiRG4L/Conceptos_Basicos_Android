...
//Crear una subclase Circulo heredad de la clase base FiguraGeometrica
open class Circulo(private var Nombre : String, private var Color: String, private var Longitud : Int, private var Ancho : Int, private var Radio: Int ): FiguraGeometrica(Nombre, Color){
